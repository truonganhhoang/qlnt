...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TBNam.hk_ren_luyen_lai'
        db.delete_column('school_tbnam', 'hk_ren_luyen_lai')

        # Deleting field 'TBNam.ren_luyen_lai'
        db.delete_column('school_tbnam', 'ren_luyen_lai')


    def backwards(self, orm):
        
        # Adding field 'TBNam.hk_ren_luyen_lai'
        db.add_column('school_tbnam', 'hk_ren_luyen_lai', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True), keep_default=False)

        # Adding field 'TBNam.ren_luyen_lai'
        db.add_column('school_tbnam', 'ren_luyen_lai', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)
