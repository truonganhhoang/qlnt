...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Pupil.uu_tien'
        db.add_column('school_pupil', 'uu_tien', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Pupil.uu_tien'
        db.delete_column('school_pupil', 'uu_tien')
