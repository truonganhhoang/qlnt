...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Subject', fields ['class_id', 'name']
        db.create_unique('school_subject', ['class_id_id', 'name'])

        # Changing field 'Pupil.uu_tien'
        db.alter_column('school_pupil', 'uu_tien', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Deleting field 'TBNam.hk_nam'
        db.delete_column('school_tbnam', 'hk_nam')


    def backwards(self, orm):
        
        # Removing unique constraint on 'Subject', fields ['class_id', 'name']
        db.delete_unique('school_subject', ['class_id_id', 'name'])

        # Changing field 'Pupil.uu_tien'
        db.alter_column('school_pupil', 'uu_tien', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Adding field 'TBNam.hk_nam'
        db.add_column('school_tbnam', 'hk_nam', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'school.pupil': {
            ...
            'school_join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 8, 8)'}),
