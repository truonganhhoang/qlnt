...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subject.index'
        db.add_column('school_subject', 'index', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Changing field 'Subject.primary'
        db.alter_column('school_subject', 'primary', self.gf('django.db.models.fields.SmallIntegerField')())


    def backwards(self, orm):
        
        # Deleting field 'Subject.index'
        db.delete_column('school_subject', 'index')

        # Changing field 'Subject.primary'
        db.alter_column('school_subject', 'primary', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'school.pupil': {
            ...
            'school_join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 27)'}),
