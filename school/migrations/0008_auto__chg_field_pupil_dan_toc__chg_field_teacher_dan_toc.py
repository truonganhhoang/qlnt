...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Pupil.dan_toc'
        db.alter_column('school_pupil', 'dan_toc', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Teacher.dan_toc'
        db.alter_column('school_teacher', 'dan_toc', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'school.pupil': {
            ...
            'dan_toc': ('django.db.models.fields.CharField', [], {'default': "'Kinh'", 'max_length': '15', 'null': 'True', 'blank': 'True'}),
            ...
            'school_join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 30)'}),
