...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Team'
        db.create_table('school_team', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('school_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Organization'])),
        ))
        db.send_create_signal('school', ['Team'])

        # Adding model 'Group'
        db.create_table('school_group', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Organization'])),
        ))
        db.send_create_signal('school', ['Group'])

        # Adding field 'Teacher.group_id'
        db.add_column('school_teacher', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['school.Group'], null=True, blank=True), keep_default=False)

        # Adding field 'Teacher.team_id'
        db.add_column('school_teacher', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['school.Team'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Team'
        db.delete_table('school_team')

        # Deleting model 'Group'
        db.delete_table('school_group')

        # Deleting field 'Teacher.group_id'
        db.delete_column('school_teacher', 'group_id_id')

        # Deleting field 'Teacher.team_id'
        db.delete_column('school_teacher', 'team_id_id')
    ...
    models = {
        ...
        'school.group': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'team_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['app.Organization']"})
        },
        'school.hanhkiem': {
        ...
        'school.pupil': {
            ...
            'school_join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 8, 10)'}),
            ...
            'uu_tien': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
        ...
        'school.subject': {
            'Meta': {'unique_together': "(('name', 'class_id'),)", 'object_name': 'Subject'},
        ...
        'school.teacher': {
            ...
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '90'}),
            'group_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['school.Group']", 'null': 'True', 'blank': 'True'}),
            'home_town': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'index': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '45', 'blank': 'True'}),
            ...
            'sex': ('django.db.models.fields.CharField', [], {'default': "'Nam'", 'max_length': '3', 'blank': 'True'}),
            'sms_phone': ('django.db.models.fields.CharField', [], {'max_length': '15', 'blank': 'True'}),
            'team_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['school.Team']", 'null': 'True', 'blank': 'True'}),
            'ton_giao': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
