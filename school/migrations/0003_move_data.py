...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for i in orm.HanhKiem.objects.all():
            i.year_id = i.student_id.class_id.year_id
            i.ren_luyen_lai = orm.TBNam.objects.get(student_id=i.student_id).ren_luyen_lai
            i.hk_ren_luyen_lai = orm.TBNam.objects.get(student_id=i.student_id).hk_ren_luyen_lai
            if i.id % 2 != 0:
                i.save()
            else:
                i.delete()
