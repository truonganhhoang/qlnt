...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'KiLuat.hinh_thuc'
        db.alter_column('school_kiluat', 'hinh_thuc', self.gf('django.db.models.fields.CharField')(max_length=35))


    def backwards(self, orm):
        
        # Changing field 'KiLuat.hinh_thuc'
        db.alter_column('school_kiluat', 'hinh_thuc', self.gf('django.db.models.fields.CharField')(max_length=30))
