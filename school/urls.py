...
urlpatterns = patterns('',
    ...
    url(r'hanhkiem/(?P<class_id>\w+)/(?P<term_number>\w+)', 'school.views.hanh_kiem'),
    ...
    url(r'viewClassDetail/(?P<class_id>\w+)/(?P<sort_type>\w+)/(?P<sort_status>\w+)/(?P<page>\w+)', 'school.views.viewClassDetail'),
